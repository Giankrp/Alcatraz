...
<template>
  <div
    ...
    <div
      ...
      <!-- Background Effects -->
      <div class="absolute top-0 right-0 -mt-16 -mr-16 size-64 bg-white/5 rounded-full blur-3xl pointer-events-none">
      </div>
      <div class="absolute bottom-0 left-0 -mb-16 -ml-16 size-64 bg-white/5 rounded-full blur-3xl pointer-events-none">
      </div>
      ...
      <div class="relative z-10">
        <transition enter-active-class="transition duration-300 ease-out"
          ...
          leave-to-class="transform -translate-x-4 opacity-0" mode="out-in">
          <component :is="currentComponent" @select="handleSelect" @back="handleBack" @save="handleSave" />
        </transition>
      </div>
    </div>
  </div>
