<script setup lang="ts">
  ...
  const handleUpdateProfile = async () => {
    ...
    const selectedLang =
      (typeof langRaw === "object" && langRaw !== null ? (langRaw as any).value : langRaw) || "es"
  ...
  <div class="min-h-screen bg-black text-zinc-400 font-sans selection:bg-emerald-500/30 py-12">
    <div class="max-w-6xl mx-auto px-8 relative">
      ...
      <header class="flex items-center gap-10 mb-16 animate-fade-in">
        ...
        <div class="flex-1">
          <h1 class="text-4xl font-normal text-zinc-100 tracking-tight mb-1">
            {{ displayName }}
          </h1>
          <p class="text-xs font-mono text-zinc-600 uppercase tracking-[0.2em] mb-6">
            {{ email }}
          </p>
          ...
          <div class="flex flex-wrap gap-3">
            <div class="badge-tech group">
              ...
              <span
                ...
                {{ (displayName || "ALCATRAZ").toUpperCase() }}</span
              >
            </div>
            <div class="badge-tech group">
              <UIcon
      ...
      <div class="grid grid-cols-1 lg:grid-cols-12 gap-16">
          ...
          <section class="animate-fade-up">
            ...
            <div class="space-y-8 mt-10">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <UFormField
                  :label="$t('profile.identity.languageLabel')"
                  :ui="{ label: 'label-tech' }"
                >
                  <USelect
              ...
              <UFormField :label="$t('profile.identity.avatarLabel')" :ui="{ label: 'label-tech' }">
                <UInput
                  ...
                  :ui="{ base: 'input-tech h-12' }"
                />
                <p class="text-[9px] text-zinc-700 mt-2 tracking-wider">
          ...
          <section class="animate-fade-up animate-delay-100">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mt-10">
              <div class="card-tech p-6 group hover:border-emerald-500/20 transition-all">
                ...
                <h3 class="text-zinc-100 font-medium text-sm mb-1">
                ...
                <p class="text-emerald-500/60 text-[10px] uppercase tracking-wider font-bold">
                  {{
                    twoFactorEnabled
                      ...
                      : $t("profile.security.twoFactorInactive")
                  }}
                </p>
              </div>
            </div>
        ...
        <div class="lg:col-span-5 space-y-12">
          ...
          <section class="animate-fade-up animate-delay-200">
            <div class="card-tech p-8 relative overflow-hidden group">
              ...
              <div class="flex items-baseline gap-4 mb-3">
                <span class="text-7xl font-light text-zinc-100 tracking-tighter">{{
                  items.length
                }}</span>
                <span class="text-[10px] font-bold text-zinc-500 uppercase tracking-[0.2em] pb-2">{{
              ...
              <div class="space-y-1">
                ...
                <div class="text-zinc-300 font-medium text-lg capitalize">
                  {{ formattedDate }}
                </div>
              </div>
            </div>
          ...
          <section class="animate-fade-up animate-delay-300">
            <div class="section-header">
              <h2 class="text-emerald-500/60 text-[10px] uppercase tracking-[0.3em] font-bold">
            ...
            <div class="grid grid-cols-2 gap-4 mt-6">
              ...
              >
                ...
                />
                <div class="text-[10px] font-bold text-zinc-200 tracking-widest uppercase mb-1">
            ...
            <div class="space-y-3 mt-6">
              ...
              >
                <div class="flex items-center gap-4">
                  ...
                  />
                  <div>
                    <div class="text-[11px] font-bold text-zinc-200 uppercase tracking-wider">
                      {{ session.browser }} en
                      {{ session.os }}
                    </div>
                    <div class="text-[9px] font-mono text-zinc-600 uppercase mt-0.5">
                      {{ session.current ? session.ip : $t("profile.devices.lastActive") }}
                    </div>
                  </div>
                </div>
                <span
                  ...
                  >{{
                    session.current ? $t("profile.devices.active") : $t("profile.devices.history")
                  }}</span
                >
              </div>
            </div>
          ...
          <section class="animate-fade-up animate-delay-500">
            <div class="card-tech p-8 border-red-500/20 bg-red-500/2">
              <div class="flex items-center gap-4 mb-6">
                ...
                <h4 class="text-[10px] font-bold text-red-500 uppercase tracking-[0.3em]">
      ...
      <footer class="mt-32 pb-8 flex justify-center">
        <span class="text-[9px] font-mono text-zinc-800 tracking-[0.6em] uppercase"
    ...
    <UModal v-model:open="showPasswordModal">
      <template #content>
        ...
        >
          <h3 class="text-lg font-bold text-zinc-100 uppercase tracking-widest mb-8">
    ...
    <UModal v-model:open="showExportModal">
      <template #content>
        ...
        >
          ...
          <h3 class="text-lg font-bold text-zinc-100 uppercase tracking-widest mb-4">
            {{ $t("profile.modals.exportVerify") }}
          </h3>
          <p class="text-xs text-zinc-600 mb-8 uppercase tracking-wider leading-relaxed">
          ...
          />
          <p v-if="exportError" class="text-[10px] text-red-500 mb-8 font-mono uppercase">
            {{
              $t(
    ...
    <UModal v-model:open="showDeleteModal">
      <template #content>
        <div class="p-10 bg-black border border-red-500/20 rounded-2xl max-w-sm mx-auto shadow-2xl">
          <h3 class="text-lg font-bold text-red-500 uppercase tracking-widest mb-4">
            {{ $t("profile.danger.modalTitle") }}
          </h3>
          <p class="text-xs text-zinc-600 mb-6 leading-relaxed">
            Para confirmar la eliminación, escribe <strong class="text-red-500">ELIMINAR</strong> en
            el siguiente campo. Esta acción es irreversible.
          </p>
          <UInput
