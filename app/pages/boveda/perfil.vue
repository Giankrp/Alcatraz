...
const handleUpdateProfile = async () => {
    ...
    const selectedLang =
        (typeof langRaw === "object" && langRaw !== null
            ? (langRaw as any).value
            : langRaw) || "es";
...
const handleUpdatePassword = async () => {
    ...
    try {
        ...
        toast.add({
            ...
            description:
                "Tu contraseña maestra ha sido actualizada de forma segura.",
            color: "success",
            icon: "i-heroicons-check-circle",
        });
        ...
        passwordErrorMessage.value =
            e?.data?.error || "Error al actualizar la contraseña";
    } finally {
...
const handleDeleteAccount = async () => {
    deleteError.value = "";
    if (deleteConfirmation.value !== t("profile.danger.deleteWord")) {
        deleteError.value = t("profile.danger.deleteWordError");
        return;
    }
    ...
    try {
        ...
        deleteError.value = t("profile.danger.deleteError");
    } finally {
...
const handleTwoFactorToggle = (val: boolean) => {
    if (val && !twoFactorEnabled.value) {
        ...
        toast.add({
            ...
            description:
                "La desactivación manual estará disponible pronto. Contacta con soporte si necesitas ayuda.",
            color: "warning",
        });
    }
};
...
const sessions = computed(() => [
    {
        ...
        ip: "192.168.1.x",
        current: true,
        lastActive: t("profile.devices.now"),
    },
    {
        browser: "Safari",
        os: "iOS",
        ip: "10.0.0.x",
        current: false,
        lastActive: t("profile.devices.lastActive"),
    },
]);
    ...
    try {
        ...
        if (Array.isArray(parsedData)) {
            ...
            toast.add({
                ...
                description: t("profile.management.importSuccessDesc", {
...
<template>
    <div
        class="min-h-screen bg-black text-zinc-400 font-sans selection:bg-emerald-500/30 py-12"
    >
        <div class="max-w-6xl mx-auto px-8 relative">
            ...
            >
                <span
                    class="group-hover:-translate-x-1 transition-transform font-mono uppercase text-[10px] tracking-widest"
                    >{{ $t("profile.back") }}</span
                >
            </UButton>
            ...
            <header class="flex items-center gap-10 mb-16 animate-fade-in">
                <div class="relative group">
                    ...
                    >
                        ...
                        <span
                            v-else
                            class="text-4xl font-light text-zinc-100"
                            >{{ initials }}</span
                        >
                        <!-- Status Dot -->
                        <div
                ...
                <div class="flex-1">
                    <h1
                        class="text-4xl font-normal text-zinc-100 tracking-tight mb-1"
                    >
                        {{ displayName }}
                    </h1>
                    <p
                        class="text-xs font-mono text-zinc-600 uppercase tracking-[0.2em] mb-6"
                    >
                        {{ email }}
                    </p>
                    ...
                    <div class="flex flex-wrap gap-3">
                        <div class="badge-tech group">
                            ...
                            />
                            <span
                                >{{ $t("profile.header.node") }}:
                                {{
                                    (displayName || "ALCATRAZ").toUpperCase()
                                }}</span
                            >
                        </div>
                        <div class="badge-tech group">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-16">
                ...
                <div class="lg:col-span-7 space-y-16">
                    ...
                    <section class="animate-fade-up">
                        ...
                        <div class="space-y-8 mt-10">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                                <UFormField
                                    :label="$t('profile.identity.nameLabel')"
                                    :ui="{ label: 'label-tech' }"
                                >
                                    <UInput
                                        v-model="editName"
                                        placeholder="Alias o nombre real"
                                        size="lg"
                                ...
                                <UFormField
                                    :label="
                                        $t('profile.identity.languageLabel')
                                    "
                                    :ui="{ label: 'label-tech' }"
                                >
                                    <USelect
                            ...
                            <UFormField
                                :label="$t('profile.identity.avatarLabel')"
                                :ui="{ label: 'label-tech' }"
                            >
                                <UInput
                                ...
                                />
                                <p
                                    class="text-[9px] text-zinc-700 mt-2 tracking-wider"
                                >
                                    {{ $t("profile.identity.avatarHelp") }}
                                </p>
                            </UFormField>
                    ...
                    <section class="animate-fade-up animate-delay-100">
                        ...
                        >
                            <div
                                class="card-tech p-6 group hover:border-emerald-500/20 transition-all"
                            >
                                <div
                                    class="flex justify-between items-start mb-10"
                                >
                                    <div
                                        class="size-10 rounded-lg bg-zinc-900 flex items-center justify-center border border-zinc-800"
                                    >
                                        <UIcon
                                            name="i-heroicons-key"
                                            class="size-5 text-emerald-500/50"
                                        />
                                    </div>
                                    <UButton
                                        variant="ghost"
                                ...
                                <h3
                                    class="text-zinc-100 font-medium text-sm mb-1"
                                >
                                    {{ $t("profile.security.masterPassword") }}
                                </h3>
                            </div>
                            ...
                            <div class="card-tech p-6">
                                ...
                                <p
                                    class="text-emerald-500/60 text-[10px] uppercase tracking-wider font-bold"
                                >
                                    {{
                                        twoFactorEnabled
                                            ? $t(
                ...
                <div class="lg:col-span-5 space-y-12">
                    ...
                    <section class="animate-fade-up animate-delay-200">
                        <div
                            class="card-tech p-8 relative overflow-hidden group"
                        >
                            <div
                                class="absolute top-4 right-4 text-[9px] font-mono text-zinc-700 tracking-widest"
                            >
                                V1.0.4
                            </div>
                            <h4 class="label-tech mb-8 opacity-60">
                                {{ $t("profile.stats.title") }}
                            </h4>

                            <div class="flex items-baseline gap-4 mb-3">
                                <span
                                    class="text-7xl font-light text-zinc-100 tracking-tighter"
                                    >{{ items.length }}</span
                                >
                                <span
                                    class="text-[10px] font-bold text-zinc-500 uppercase tracking-[0.2em] pb-2"
                                    >{{ $t("profile.stats.items") }}</span
                                >
                            </div>

                            <div
                                class="w-full h-[3px] bg-zinc-900 rounded-full mb-12"
                            >
                                <div
                                    class="h-full bg-emerald-500/40 w-1/3 rounded-full shadow-[0_0_8px_rgba(16,185,129,0.2)]"
                                />
                            </div>

                            <div class="space-y-1">
                                <h5 class="label-tech opacity-40">
                                    {{ $t("profile.stats.memberSince") }}
                                </h5>
                                <div
                                    class="text-zinc-300 font-medium text-lg capitalize"
                                >
                                    {{ formattedDate }}
                                </div>
                            </div>
                    ...
                    <section class="animate-fade-up animate-delay-300">
                        <div class="section-header">
                            <h2
                                class="text-emerald-500/60 text-[10px] uppercase tracking-[0.3em] font-bold"
                            >
                        ...
                        <div class="grid grid-cols-2 gap-4 mt-6">
                            ...
                            >
                                ...
                                />
                                <div
                                    class="text-[10px] font-bold text-zinc-200 tracking-widest uppercase mb-1"
                                >
                                    {{ $t("profile.management.export") }}
                                </div>
                                <div class="text-[9px] text-zinc-600 font-mono">
                                    {{ $t("profile.management.exportDesc") }}
                                </div>
                            </button>
                            <button
                            ...
                            >
                                ...
                                <div
                                    class="text-[10px] font-bold text-zinc-200 tracking-widest uppercase mb-1"
                                >
                                    {{ $t("profile.management.import") }}
                                </div>
                                <div class="text-[9px] text-zinc-600 font-mono">
                                    {{ $t("profile.management.importDesc") }}
                                </div>
                            </button>
                            <input
                                type="file"
                        ...
                        <div class="space-y-3 mt-6">
                            ...
                            >
                                <div class="flex items-center gap-4">
                                    ...
                                    <div>
                                        <div
                                            class="text-[11px] font-bold text-zinc-200 uppercase tracking-wider"
                                        >
                                            {{ session.browser }} en
                                            {{ session.os }}
                                        </div>
                                        <div
                                            class="text-[9px] font-mono text-zinc-600 uppercase mt-0.5"
                                        >
                                            {{
                                                session.current
                                                    ? session.ip
                                                    : $t(
                                                          "profile.devices.lastActive",
                                                      )
                                            }}
                                        </div>
                                    </div>
                                ...
                                <span
                                    ...
                                    >{{
                                        session.current
                                            ? $t("profile.devices.active")
                                            : $t("profile.devices.history")
                                    }}</span
                                >
                            </div>
                        </div>
                    ...
                    <section class="animate-fade-up animate-delay-500">
                        <div
                            class="card-tech p-8 border-red-500/20 bg-red-500/2"
                        >
                            <div class="flex items-center gap-4 mb-6">
                                <div
                                    class="size-10 rounded-lg bg-red-500/10 flex items-center justify-center border border-red-500/20"
                                >
                                    <UIcon
                                ...
                                <h4
                                    class="text-[10px] font-bold text-red-500 uppercase tracking-[0.3em]"
                                >
                                    {{ $t("profile.danger.title") }}
                                </h4>
                            </div>
                            <p
                                class="text-[11px] text-zinc-600 leading-relaxed mb-10"
                            >
            ...
            <footer class="mt-32 pb-8 flex justify-center">
                <span
                    class="text-[9px] font-mono text-zinc-800 tracking-[0.6em] uppercase"
                    >VAULT SYSTEMS SECURITY</span
                >
            </footer>
        </div>
        ...
        <UModal v-model:open="showPasswordModal">
            <template #content>
                ...
                >
                    <h3
                        class="text-lg font-bold text-zinc-100 uppercase tracking-widest mb-8"
                    >
            ...
            <template #content>
                ...
                >
                    <UIcon
                        ...
                        class="size-12 text-emerald-500 mb-6 mx-auto"
                    />
                    <h3
                        class="text-lg font-bold text-zinc-100 uppercase tracking-widest mb-4"
                    >
                        {{ $t("profile.modals.exportVerify") }}
                    </h3>
                    <p
                        class="text-xs text-zinc-600 mb-8 uppercase tracking-wider leading-relaxed"
                    >
                        {{ $t("profile.modals.exportAuth") }}
                    </p>
                    <UInput
                        v-model="exportPassword"
                        type="password"
                        :placeholder="$t('profile.modals.exportPassword')"
                        class="mb-3"
                        :ui="{ base: 'input-tech text-white' }"
                    ...
                    <p
                        v-if="exportError"
                        class="text-[10px] text-red-500 mb-8 font-mono uppercase"
                    >
                        {{
                            $t(
                                `profile.modals.${exportError === "Contraseña maestra incorrecta" ? "masterPasswordError" : ""}`,
                            ) || exportError
                        }}
                    </p>
        ...
        <UModal v-model:open="showDeleteModal">
            <template #content>
                <div
                    class="p-10 bg-black border border-red-500/20 rounded-2xl max-w-sm mx-auto shadow-2xl"
                >
                    <h3
                        class="text-lg font-bold text-red-500 uppercase tracking-widest mb-4"
                    >
                        {{ $t("profile.danger.modalTitle") }}
                    </h3>
                    <p class="text-xs text-zinc-600 mb-6 leading-relaxed">
                        {{
                            $t("profile.danger.deleteConfirmHelp", {
                                text: $t("profile.danger.deleteWord"),
                            })
                        }}
                    </p>
                    <UInput
                        v-model="deleteConfirmation"
                        :placeholder="$t('profile.danger.deleteWord')"
                        class="mb-2"
                        :ui="{
                            base: 'input-tech text-white border-red-500/30 focus-within:border-red-500/60',
                        }"
                        @keyup.enter="handleDeleteAccount"
                    />
                    <p
                        v-if="deleteError"
                        class="text-[10px] text-red-500 mb-6 font-mono uppercase tracking-wider"
                    >
                        {{ deleteError }}
                    </p>
                    <div class="flex flex-col gap-3 mt-8">
                        ...
                        <UButton
                            ...
                            >{{ $t("profile.danger.cancel") }}</UButton
                        >
                    </div>
                </div>
            </template>
        ...
        <ProfileTwoFactorSetup
            v-model:open="showTwoFactorSetup"
            @enabled="fetchUser"
        />
    </div>
</template>
