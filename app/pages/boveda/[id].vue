    ...
    navigator.clipboard
        ...
        .then(() => {
            toast.add({
                ...
                description: t("vault.itemDetails.copiedDesc", {
                    field: label,
                }),
                color: "success",
...
const timeSince = (date?: string) => {
    ...
    if (interval > 1)
        return t("vault.itemDetails.time.years", {
            count: Math.floor(interval),
        });
    interval = seconds / 2592000;
    if (interval > 1)
        return t("vault.itemDetails.time.months", {
            count: Math.floor(interval),
        });
    interval = seconds / 86400;
    if (interval > 1)
        return t("vault.itemDetails.time.days", {
            count: Math.floor(interval),
        });
    interval = seconds / 3600;
    if (interval > 1)
        return t("vault.itemDetails.time.hours", {
            count: Math.floor(interval),
        });
    interval = seconds / 60;
    if (interval > 1)
        return t("vault.itemDetails.time.minutes", {
            count: Math.floor(interval),
        });
                                    ...
                                    <div class="grid grid-cols-2 gap-4">
                                        <template
                                            v-for="(val, key) in {
                                                docType:
                                                    asIdentity.docType ||
                                                    (asIdentity.licenseNumber
                                                        ? 'license'
                                                        : asIdentity.passportNumber
                                                          ? 'passport'
                                                          : 'dni'),
                                                idNumber:
                                                    asIdentity.idNumber ||
                                            ...
                                            >
                                                    ...
                                                    {{
                                                        key === "idNumber"
                                                            ? (asIdentity.docType ||
                                                              ...
                                                              "other"
                                                                ? $t(
                                                                      "vault.forms.identityForm.idNumberLabel",
                                                                  )
                                                                : $t(
                                                                      `vault.forms.identityForm.types.${asIdentity.docType || (asIdentity.licenseNumber ? "license" : asIdentity.passportNumber ? "passport" : "dni")}`,
                                                                  )
                                                            : key === "docType"
                                                              ? $t(
                                                                    "vault.forms.identityForm.typeLabel",
                                                                )
                                                              : key === "expiry"
                                                                ? $t(
                                                                      "vault.forms.identityForm.expiryLabel",
                                                                  )
                                                                : String(
                                                                      key,
                                                                  ).toUpperCase()
                                                ...
                                                <div class="text-zinc-200">
                                                    {{
                                                        key === "docType"
                                                            ? $t(
                                                                  `vault.forms.identityForm.types.${val}`,
                                                              )
                                                            : val
                                                    }}
                                                </div>
                                ...
                                <div class="space-y-2">
                                    <div class="flex justify-between items-end">
                                        <span
                                            ...
                                            >{{
                                                $t(
                                                    "vault.itemDetails.passwordStrength",
                                                )
                                            }}</span
                                        >
                                        <span
                                            ...
                                            >{{
                                                passwordStrength > 75
                                                    ? $t(
                                                          "vault.itemDetails.strengthRobust",
                                                      )
                                                    : $t(
                                                          "vault.itemDetails.strengthVulnerable",
                                                      )
                                            }}</span
                                        >
                                    </div>
                    ...
                    <div>
                        <h3 class="text-xl font-light text-white">
                            {{
                                isTrashed
                                    ? $t(
                                          "vault.itemDetails.deletePermanentQuestion",
                                      )
                                    : $t(
                                          "vault.itemDetails.moveToTrashQuestion",
                                      )
                            }}
                        </h3>
                        <p class="text-sm text-zinc-500">
                            {{
                                isTrashed
                                    ? $t(
                                          "vault.itemDetails.deletePermanentWarning",
                                      )
