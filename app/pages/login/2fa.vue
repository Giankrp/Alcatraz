...
const onVerify = async () => {
    ...
    try {
        const response = await $fetch<any>(
            `${config.public.apiBase}/api/auth/2fa/verify`,
            {
                method: "POST",
        ...
        errorMsg.value = e.data?.error || t("auth.2fa.error");
        toast.add({
            ...
            <div class="mx-auto max-w-sm relative z-10">
                ...
                >
                    <div class="text-center mb-10">
                        ...
                        <h1
                            class="text-2xl font-bold tracking-tight text-white mb-2 uppercase tracking-widest"
                        >
                            {{
                                isBackupCode
                                    ? $t("auth.2fa.backup")
                        ...
                        <p
                            class="text-xs text-zinc-500 uppercase tracking-widest font-mono"
                        >
                            {{ twoFactorEmail }}
                        </p>
                    </div>
