<script lang="ts" setup>
  ...
  useHead(() => ({
    ...
    meta: [{ name: "description", content: t("pricing.desc") }],
  }))
    ...
    const p: PricingPlanProps[] = [
      {
        ...
        button: {
          ...
          block: true,
          class:
            "hover:bg-green-500/10 hover:border-green-500/30 hover:text-green-400 transition-colors",
        },
        ui: commonUi,
      },
      {
        ...
        button: {
          label: t("pricing.plans.premium.button"),
          to: "/login",
          size: "lg",
          block: true,
          class: "btn-accent",
...
<template>
  <div class="relative min-h-screen bg-black text-white overflow-hidden">
    ...
    <div class="absolute inset-0 pointer-events-none">
      <div
        class="absolute top-0 left-1/2 -translate-x-1/2 w-200 h-150 bg-green-500/10 rounded-full blur-[120px]"
      ></div>
      <div
        class="absolute bottom-0 right-0 w-150 h-150 bg-green-900/20 rounded-full blur-[100px]"
      ></div>
    </div>
